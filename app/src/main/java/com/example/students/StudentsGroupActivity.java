...
public class StudentsGroupActivity extends AppCompatActivity {
    ...
    public void onOkBtnClick(View view) {
        String outString = "Group: " + ((TextView) findViewById(R.id.grpNumberEdit)).getText() + "\n";
        outString += "Faculty: " + ((TextView) findViewById(R.id.facultyEdit)).getText() + "\n";
        if (((RadioButton) findViewById(R.id.edu_level_master)).isChecked()){
            outString += "Education level: " + "master\n";
        } else {
            outString += "Education level: " + "bachelor\n";
        }
        if (((CheckBox) findViewById(R.id.contract_flg)).isChecked()){
            outString += "✓ contract students\n";
        } else {
            outString += "✘ contract students\n";
        }
        if (((CheckBox) findViewById(R.id.privilege_flg)).isChecked()){
            outString += "✓ beneficiary students\n";
        } else {
            outString += "✘ beneficiary students\n";
        }
